...
<div class="container d-flex flex-wrap justify-content-between" style="margin-top: 25px; padding-left: 70px;">
    <div class="card" style="width: 18rem; ">
      <img src="./products/pants/pants_starrynight.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Pocket Starrynight<br>
        P500.00</h5>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/pants/pants_sunflowers.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Skirt Sunflower Pocket<br>
        P500.00</h5>
        <p class="card-text">Artist: Pauline Bactad</p>
        <a href="#" class="btn btn-primary">View Item</a>
      </div>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/pants/pants_sunflowers1.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Pocket Sunflower<br>
        P500.00</h5>
        <p class="card-text">Artist: Pauline Bactad</p>
        <a href="#" class="btn btn-primary">View Item</a>
      </div>
