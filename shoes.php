...
<div class="container d-flex flex-wrap justify-content-between" style="margin-top: 25px; padding-left: 70px;">
    <div class="card" style="width: 18rem; ">
      <img src="./products/shoes/shoes_galaxy.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Galaxy<br>
        P500.00</h5>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/shoes/shoes_sunflowers1.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Sunflowers<br>
        P500.00</h5>
        <p class="card-text">Artist: Pauline Bactad</p>
        <a href="#" class="btn btn-primary">View Item</a>
      </div>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/shoes/shoes_thewave.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">The Wave<br>
        P500.00</h5>
        <p class="card-text">Artist: Pauline Bactad</p>
        <a href="#" class="btn btn-primary">View Item</a>
      </div>
