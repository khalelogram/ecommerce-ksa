...
<div class="container d-flex flex-wrap justify-content-between" style="margin-top: 25px; padding-left: 70px;">
    <div class="card" style="width: 18rem; ">
      <img src="./products/others/bookmarks.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Bookmarks<br>
        P500.00</h5>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/others/stickers.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Stickers<br>
        P500.00</h5>
        <p class="card-text">Artist: Pauline Bactad</p>
        <a href="#" class="btn btn-primary">View Item</a>
      </div>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/others/bag_wheatfieldspainting.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Personalized Tote Bag<br>
        P500.00</h5>
        <p class="card-text">Artist: Pauline Bactad</p>
        <a href="#" class="btn btn-primary">View Item</a>
      </div>
