<?php 
include 'db.php';
include 'server-hats.php';
include('inc/header.php'); 
include ('inc/functions.php');


$hats = "SELECT * FROM `products` WHERE `prod_cat` = 'hats'";
$result2 = mysqli_query($dbconnection, $hats);
$valid = false;
$msg = "";
...
<?php include('inc/sidebar.php'); ?>
    ...
    <div class="col">
        ...
        <div class="card">
            <h4 class="card-header">Category Hats</h4>
            <div class="card-body">
            <div class="jumbotron"> 
                    <div class="row d-flex justify-content-around">
                      <?php while ($row = mysqli_fetch_array($result2)): ?>
                      <div class="card" style="width: 18rem;">
                        <?php echo '<img src="hats-web/'.$row['prod_img'].'"width="285" height="200" />'; ?>
                        <div class="card-body">
                                <p class="card-title">
                                ...
                                <table>
                                <td><a class="btn btn-success" href="hats.php?edit=<?php echo $row['prod_id'];?>">Edit</a></td>
                                <td><a class="btn btn-danger" href="server-hats.php?del=<?php echo $row['prod_id'];?>">Remove</a></td>
                                </tr>
                                </table>
                        </div>
                      </div>
      ...
      <div class="card-body">
        <div class="container ">  
          <div class="col-sm-10 col-lg-4 mr-auto border p-4">
                <form method="POST" action="server-hats.php" enctype="multipart/form-data">
                <div>
          ...
          <div>
            ...
            <select name="prodcat" value="<?php echo $prodcat; ?>">
              <option value="hats">T-shirt</option>
