...
<div class="container d-flex flex-wrap justify-content-between" style="margin-top: 25px; padding-left: 70px;">
    <div class="card" style="width: 18rem; ">
      <img src="./products/mural-services/mural_starrynight.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Starrynight by Van Gogh<br>
        P500.00</h5>
    ...
    <div class="card" style="width: 18rem; ">
      <img src="./products/mural-services/mural_sunflowers.jpg" class="card-img-top" alt="...">
      <div class="card-body">
